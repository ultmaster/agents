...
the first of `$CI_PROFILE_DIR`, `<repository-root>/.agents/skills/ci-operations`,
`<repository-root>/.claude/skills/ci-operations`, then this skill's root — so one project's
